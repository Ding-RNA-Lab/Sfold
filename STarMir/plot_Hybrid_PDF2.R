...
# creates a PDF file depicting the hybridization
# described by its input arguments.  The file name
# is created using the filename prefix given as an argument.
#
# Modifications are
...
#
# usage plot_Hybrid_PDF.R <Output filename> <Target Name> <miRNA Name> <site position> <Tar MisMat> <Tar Mat> <miRNA Mat> <miRNA MisMat> <dG Hybrid>
#
# 2013/4/26 (war)
# modified to take output filename as argument rather than site id number.  It makes
# the script more generic
#
...
plot_Hybrid =function(site,startX=0.1,startY=0.5){
    # Example for input
    #                   Output filename	site[1]: foo.pdf
